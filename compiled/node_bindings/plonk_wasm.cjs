...
module.exports.caml_bn254_fp_plonk_verifier_index_deserialize = function(srs, index) {
    ...
    const ptr0 = passStringToWasm0(index, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.caml_bn254_fp_plonk_verifier_index_deserialize(srs.__wbg_ptr, ptr0, len0);
...
module.exports.caml_bn254_fq_size_in_bits = function() {
    const ret = wasm.caml_bn254_fq_size_in_bits();
    return ret;
};
...
* Range check
*/
RangeCheck0:12,"12":"RangeCheck0",RangeCheck1:13,"13":"RangeCheck1",ForeignFieldAdd:14,"14":"ForeignFieldAdd",ForeignFieldMul:15,"15":"ForeignFieldMul",Xor16:16,"16":"Xor16",Rot64:17,"17":"Rot64",KeccakRound:18,"18":"KeccakRound",KeccakSponge:19,"19":"KeccakSponge", });
/**
...
class WasmBn254FpGate {
    ...
    */
    get_coeffs_bigint() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.wasmbn254fpgate_get_coeffs_bigint(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
...
class WasmBn254FpPlonkVerifierIndex {
    ...
    */
    get zk_rows() {
        const ret = wasm.__wbg_get_wasmbn254fpplonkverifierindex_zk_rows(this.__wbg_ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set zk_rows(arg0) {
        wasm.__wbg_set_wasmbn254fpplonkverifierindex_zk_rows(this.__wbg_ptr, arg0);
    }
    /**
    ...
    */
    constructor(domain, max_poly_size, public_, prev_challenges, srs, evals, shifts, lookup_index, zk_rows) {
        ...
        const ret = wasm.wasmbn254fpplonkverifierindex_new(domain.__wbg_ptr, max_poly_size, public_, prev_challenges, srs.__wbg_ptr, evals.__wbg_ptr, shifts.__wbg_ptr, ptr0, zk_rows);
        return WasmBn254FpPlonkVerifierIndex.__wrap(ret);
    }
    /**
    * @returns {WasmBn254FpSrs}
...
module.exports.__wbg_log_c6139d418b551047 = function(arg0) {

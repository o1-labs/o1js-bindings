...
*/
module.exports.caml_pasta_fp_plonk_index_create = function(gates, public_, lookup_tables, runtime_tables, prev_challenges, srs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(gates, WasmFpGateVector);
        const ptr0 = passArray32ToWasm0(lookup_tables, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray32ToWasm0(runtime_tables, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
...
*/
module.exports.caml_pasta_fq_plonk_index_create = function(gates, public_, lookup_tables, runtime_tables, prev_challenges, srs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {WasmFpProverProof}
*/
module.exports.caml_pasta_fp_plonk_proof_create = function(index, witness, runtime_tables, prev_challenges, prev_sgs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(index, WasmPastaFpPlonkIndex);
...
* @returns {WasmFqProverProof}
*/
module.exports.caml_pasta_fq_plonk_proof_create = function(index, witness, runtime_tables, prev_challenges, prev_sgs) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(index, WasmPastaFqPlonkIndex);
...
/**
*/
class WasmPastaFpRuntimeTable {

    static __wrap(ptr) {
        const obj = Object.create(WasmPastaFpRuntimeTable.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmpastafpruntimetable_free(ptr);
    }
    /**
    * @param {number} id
    ...
    */
    constructor(id, data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpastafpruntimetable_new(id, ptr0, len0);
        return WasmPastaFpRuntimeTable.__wrap(ret);
    }
}
module.exports.WasmPastaFpRuntimeTable = WasmPastaFpRuntimeTable;
/**
*/
...
/**
*/
class WasmPastaFqRuntimeTable {

    static __wrap(ptr) {
        const obj = Object.create(WasmPastaFqRuntimeTable.prototype);
        obj.ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wasmpastafqruntimetable_free(ptr);
    }
    /**
    * @param {number} id
    * @param {Uint8Array} data
    */
    constructor(id, data) {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmpastafqruntimetable_new(id, ptr0, len0);
        return WasmPastaFqRuntimeTable.__wrap(ret);
    }
}
module.exports.WasmPastaFqRuntimeTable = WasmPastaFqRuntimeTable;
/**
*/

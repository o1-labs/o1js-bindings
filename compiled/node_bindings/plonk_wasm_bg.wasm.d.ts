...
export function wasmbn254fpplonkverifierindex_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number): number;
...
export function caml_bn254_fp_plonk_verifier_index_deserialize(a: number, b: number, c: number, d: number): void;

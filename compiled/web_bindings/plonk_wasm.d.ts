...
* @param {Uint32Array} runtime_tables
* @param {number} prev_challenges
* @param {WasmFpSrs} srs
* @returns {WasmPastaFpPlonkIndex}
*/
export function caml_pasta_fp_plonk_index_create(gates: WasmFpGateVector, public_: number, lookup_tables: Uint32Array, runtime_tables: Uint32Array, prev_challenges: number, srs: WasmFpSrs): WasmPastaFpPlonkIndex;
/**
...
*/
export function caml_pasta_fq_plonk_index_create(gates: WasmFqGateVector, public_: number, lookup_tables: Uint32Array, runtime_tables: Uint32Array, prev_challenges: number, srs: WasmFqSrs): WasmPastaFqPlonkIndex;
/**
...
* @returns {WasmFpProverProof}
*/
export function caml_pasta_fp_plonk_proof_create(index: WasmPastaFpPlonkIndex, witness: WasmVecVecFp, runtime_tables: Uint32Array, prev_challenges: Uint8Array, prev_sgs: Uint32Array): WasmFpProverProof;
/**
* @param {WasmFpPlonkVerifierIndex} index
* @param {WasmFpProverProof} proof
* @returns {boolean}
...
* @returns {WasmFqProverProof}
*/
export function caml_pasta_fq_plonk_proof_create(index: WasmPastaFqPlonkIndex, witness: WasmVecVecFq, runtime_tables: Uint32Array, prev_challenges: Uint8Array, prev_sgs: Uint32Array): WasmFqProverProof;
/**
* @param {WasmFqPlonkVerifierIndex} index
* @param {WasmFqProverProof} proof
* @returns {boolean}
...
/**
*/
export class WasmPastaFpRuntimeTable {
  free(): void;
/**
* @param {number} id
...
/**
*/
export class WasmPastaFqRuntimeTable {
  free(): void;
/**
* @param {number} id
* @param {Uint8Array} data
...
export interface InitOutput {
  ...
  readonly __wbg_wasmpastafpruntimetable_free: (a: number) => void;
  readonly wasmpastafpruntimetable_new: (a: number, b: number, c: number) => number;
  ...
  readonly wasmpastafqruntimetable_new: (a: number, b: number, c: number) => number;
  ...
  readonly __wbg_wasmpastafqruntimetable_free: (a: number) => void;

...
* @returns {WasmFpGateVector}
*/
export function caml_bn254_fp_plonk_gate_vector_create() {
    const ret = wasm.caml_bn254_fp_plonk_gate_vector_create();
    return WasmFpGateVector.__wrap(ret);
}
...
* @param {WasmFpGate} gate
*/
export function caml_bn254_fp_plonk_gate_vector_add(v, gate) {
    _assertClass(v, WasmFpGateVector);
    _assertClass(gate, WasmFpGate);
    var ptr0 = gate.__destroy_into_raw();
    wasm.caml_bn254_fp_plonk_gate_vector_add(v.__wbg_ptr, ptr0);
}
...
* @returns {WasmFpGate}
*/
export function caml_bn254_fp_plonk_gate_vector_get(v, i) {
    _assertClass(v, WasmFpGateVector);
    const ret = wasm.caml_bn254_fp_plonk_gate_vector_get(v.__wbg_ptr, i);
    return WasmFpGate.__wrap(ret);
}
...
* @returns {number}
*/
export function caml_bn254_fp_plonk_gate_vector_len(v) {
    _assertClass(v, WasmFpGateVector);
    const ret = wasm.caml_bn254_fp_plonk_gate_vector_len(v.__wbg_ptr);
    return ret >>> 0;
}
...
* @param {Wire} h
*/
export function caml_bn254_fp_plonk_gate_vector_wrap(v, t, h) {
    _assertClass(v, WasmFpGateVector);
    _assertClass(t, Wire);
    var ptr0 = t.__destroy_into_raw();
    _assertClass(h, Wire);
    var ptr1 = h.__destroy_into_raw();
    wasm.caml_bn254_fp_plonk_gate_vector_wrap(v.__wbg_ptr, ptr0, ptr1);
}
...
* @returns {Uint8Array}
*/
export function caml_bn254_fp_plonk_gate_vector_digest(public_input_size, v) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(v, WasmFpGateVector);
        wasm.caml_bn254_fp_plonk_gate_vector_digest(retptr, public_input_size, v.__wbg_ptr);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var v1 = getArrayU8FromWasm0(r0, r1).slice();
        wasm.__wbindgen_free(r0, r1 * 1);

...
export function __wbg_wasmpastafpruntimetable_free(a: number): void;
export function wasmpastafpruntimetable_new(a: number, b: number, c: number): number;
...
export function wasmpastafqruntimetable_new(a: number, b: number, c: number): number;
...
export function __wbg_wasmpastafqruntimetable_free(a: number): void;

...
export function wasmvecvecfp_get(a: number, b: number, c: number): void;
export function wasmvecvecfp_set(a: number, b: number, c: number, d: number): void;
export function __wbg_wasmgbn254_free(a: number): void;
export function __wbg_get_wasmgbn254_x(a: number, b: number): void;
export function __wbg_set_wasmgbn254_x(a: number, b: number, c: number): void;
export function __wbg_get_wasmgbn254_y(a: number, b: number): void;
export function __wbg_set_wasmgbn254_y(a: number, b: number, c: number): void;
export function __wbg_get_wasmgbn254_infinity(a: number): number;
export function __wbg_set_wasmgbn254_infinity(a: number, b: number): void;
export function caml_pallas_affine_one(): number;
export function caml_vesta_affine_one(): number;
export function caml_bn254_affine_one(): number;
>>>>>>> origin/wasm_kzg_prover
...
=======
export function __wbg_wasmbn254fpsrs_free(a: number): void;
export function caml_bn254_fp_srs_create(a: number): number;
export function caml_bn254_fp_srs_add_lagrange_basis(a: number, b: number): void;
export function caml_bn254_fp_srs_write(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_srs_read(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_srs_lagrange_commitment(a: number, b: number, c: number, d: number): void;
export function caml_bn254_fp_srs_commit_evaluations(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_srs_b_poly_commitment(a: number, b: number, c: number, d: number): void;
export function caml_bn254_fp_srs_batch_accumulator_check(a: number, b: number, c: number, d: number, e: number): number;
export function caml_bn254_fp_srs_batch_accumulator_generate(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_srs_h(a: number): number;
>>>>>>> origin/wasm_kzg_prover
...
export function __wbg_wasmbn254fpdomain_free(a: number): void;
export function __wbg_get_wasmbn254fpdomain_log_size_of_group(a: number): number;
export function __wbg_set_wasmbn254fpdomain_log_size_of_group(a: number, b: number): void;
export function __wbg_get_wasmbn254fpdomain_group_gen(a: number, b: number): void;
export function __wbg_set_wasmbn254fpdomain_group_gen(a: number, b: number, c: number): void;
export function wasmbn254fpdomain_new(a: number, b: number, c: number): number;
export function __wbg_wasmbn254fpplonkverificationevals_free(a: number): void;
export function wasmbn254fpplonkverificationevals_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number): number;
export function wasmbn254fpplonkverificationevals_sigma_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_set_sigma_comm(a: number, b: number, c: number): void;
export function wasmbn254fpplonkverificationevals_coefficients_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_set_coefficients_comm(a: number, b: number, c: number): void;
export function wasmbn254fpplonkverificationevals_generic_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_set_generic_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_psm_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_set_psm_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_complete_add_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_set_complete_add_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_mul_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_set_mul_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_emul_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_set_emul_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_endomul_scalar_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_set_endomul_scalar_comm(a: number, b: number): void;
export function __wbg_wasmbn254fpshifts_free(a: number): void;
export function __wbg_get_wasmbn254fpshifts_s1(a: number, b: number): void;
export function __wbg_set_wasmbn254fpshifts_s1(a: number, b: number, c: number): void;
export function __wbg_get_wasmbn254fpshifts_s2(a: number, b: number): void;
export function __wbg_set_wasmbn254fpshifts_s2(a: number, b: number, c: number): void;
export function __wbg_get_wasmbn254fpshifts_s3(a: number, b: number): void;
export function __wbg_set_wasmbn254fpshifts_s3(a: number, b: number, c: number): void;
export function __wbg_get_wasmbn254fpshifts_s4(a: number, b: number): void;
export function __wbg_set_wasmbn254fpshifts_s4(a: number, b: number, c: number): void;
export function __wbg_get_wasmbn254fpshifts_s5(a: number, b: number): void;
export function __wbg_set_wasmbn254fpshifts_s5(a: number, b: number, c: number): void;
export function __wbg_get_wasmbn254fpshifts_s6(a: number, b: number): void;
export function __wbg_set_wasmbn254fpshifts_s6(a: number, b: number, c: number): void;
export function wasmbn254fpshifts_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number): number;
export function __wbg_wasmbn254fplookupselectors_free(a: number): void;
export function wasmbn254fplookupselectors_new(a: number, b: number, c: number, d: number): number;
export function wasmbn254fplookupselectors_xor(a: number): number;
export function wasmbn254fplookupselectors_set_xor(a: number, b: number): void;
export function wasmbn254fplookupselectors_lookup(a: number): number;
export function wasmbn254fplookupselectors_set_lookup(a: number, b: number): void;
export function wasmbn254fplookupselectors_ffmul(a: number): number;
export function wasmbn254fplookupselectors_set_ffmul(a: number, b: number): void;
export function wasmbn254fplookupselectors_range_check(a: number): number;
export function wasmbn254fplookupselectors_set_range_check(a: number, b: number): void;
export function __wbg_wasmbn254fplookupverifierindex_free(a: number): void;
export function __wbg_get_wasmbn254fplookupverifierindex_joint_lookup_used(a: number): number;
export function __wbg_set_wasmbn254fplookupverifierindex_joint_lookup_used(a: number, b: number): void;
export function wasmbn254fplookupverifierindex_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number): number;
export function wasmbn254fplookupverifierindex_lookup_table(a: number, b: number): void;
export function wasmbn254fplookupverifierindex_set_lookup_table(a: number, b: number, c: number): void;
export function wasmbn254fplookupverifierindex_lookup_selectors(a: number): number;
export function wasmbn254fplookupverifierindex_set_lookup_selectors(a: number, b: number): void;
export function wasmbn254fplookupverifierindex_table_ids(a: number): number;
export function wasmbn254fplookupverifierindex_set_table_ids(a: number, b: number): void;
export function wasmbn254fplookupverifierindex_lookup_info(a: number): number;
export function wasmbn254fplookupverifierindex_set_lookup_info(a: number, b: number): void;
export function wasmbn254fplookupverifierindex_runtime_tables_selector(a: number): number;
export function wasmbn254fplookupverifierindex_set_runtime_tables_selector(a: number, b: number): void;
export function __wbg_wasmbn254fpplonkverifierindex_free(a: number): void;
export function __wbg_get_wasmbn254fpplonkverifierindex_domain(a: number): number;
export function __wbg_set_wasmbn254fpplonkverifierindex_domain(a: number, b: number): void;
export function __wbg_get_wasmbn254fpplonkverifierindex_max_poly_size(a: number): number;
export function __wbg_set_wasmbn254fpplonkverifierindex_max_poly_size(a: number, b: number): void;
export function __wbg_get_wasmbn254fpplonkverifierindex_public_(a: number): number;
export function __wbg_set_wasmbn254fpplonkverifierindex_public_(a: number, b: number): void;
export function __wbg_get_wasmbn254fpplonkverifierindex_prev_challenges(a: number): number;
export function __wbg_set_wasmbn254fpplonkverifierindex_prev_challenges(a: number, b: number): void;
export function __wbg_get_wasmbn254fpplonkverifierindex_shifts(a: number): number;
export function __wbg_set_wasmbn254fpplonkverifierindex_shifts(a: number, b: number): void;
export function __wbg_get_wasmbn254fpplonkverifierindex_zk_rows(a: number): number;
export function __wbg_set_wasmbn254fpplonkverifierindex_zk_rows(a: number, b: number): void;
export function wasmbn254fpplonkverifierindex_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function wasmbn254fpplonkverifierindex_srs(a: number): number;
export function wasmbn254fpplonkverifierindex_set_srs(a: number, b: number): void;
export function wasmbn254fpplonkverifierindex_evals(a: number): number;
export function wasmbn254fpplonkverifierindex_set_evals(a: number, b: number): void;
export function wasmbn254fpplonkverifierindex_lookup_index(a: number): number;
export function wasmbn254fpplonkverifierindex_set_lookup_index(a: number, b: number): void;
export function caml_bn254_fp_plonk_verifier_index_read(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function caml_bn254_fp_plonk_verifier_index_write(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_plonk_verifier_index_serialize(a: number, b: number): void;
export function caml_bn254_fp_plonk_verifier_index_deserialize(a: number, b: number, c: number): number;
export function caml_bn254_fp_plonk_verifier_index_create(a: number): number;
export function caml_bn254_fp_plonk_verifier_index_shifts(a: number): number;
export function caml_bn254_fp_plonk_verifier_index_dummy(): number;
export function caml_bn254_fp_plonk_verifier_index_deep_copy(a: number): number;
...
=======
export function wasmbn254fppolycomm_new(a: number, b: number, c: number): number;
export function wasmbn254fppolycomm_unshifted(a: number, b: number): void;
export function wasmbn254fppolycomm_set_unshifted(a: number, b: number, c: number): void;
export function __wbg_wasmbn254fppolycomm_free(a: number): void;
export function __wbg_get_wasmbn254fppolycomm_shifted(a: number): number;
export function __wbg_set_wasmbn254fppolycomm_shifted(a: number, b: number): void;
export function wasmfppolycomm_new(a: number, b: number, c: number): number;
export function wasmfppolycomm_unshifted(a: number, b: number): void;
export function wasmfppolycomm_set_unshifted(a: number, b: number, c: number): void;
...
export function wasmbn254fpplonkverificationevals_range_check0_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_foreign_field_add_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_range_check1_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_foreign_field_mul_comm(a: number): number;
export function wasmbn254fpplonkverificationevals_rot_comm(a: number): number;
>>>>>>> origin/wasm_kzg_prover
...
export function wasmfpplonkverificationevals_set_xor_comm(a: number, b: number): void;
export function wasmfplookupselectors_set_xor(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_set_xor_comm(a: number, b: number): void;
...
export function wasmbn254fpplonkverificationevals_set_range_check0_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_set_foreign_field_add_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_set_range_check1_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_set_foreign_field_mul_comm(a: number, b: number): void;
export function wasmbn254fpplonkverificationevals_set_rot_comm(a: number, b: number): void;
export function __wbg_wasmpastafqlookuptable_free(a: number): void;
export function caml_pasta_fq_plonk_index_domain_d1_size(a: number): number;
export function caml_pasta_fq_plonk_index_domain_d4_size(a: number): number;
export function caml_pasta_fq_plonk_index_domain_d8_size(a: number): number;
...
export function __wbg_get_wasmbn254fpshifts_s0(a: number, b: number): void;
...
export function __wbg_set_wasmbn254fpshifts_s0(a: number, b: number, c: number): void;
...
export function wasmfpplonkverificationevals_xor_comm(a: number): number;
export function wasmfplookupselectors_xor(a: number): number;
export function wasmbn254fpplonkverificationevals_xor_comm(a: number): number;
...
export function __wbg_wasmbn254fpgatevector_free(a: number): void;
export function __wbg_wasmbn254fpgate_free(a: number): void;
export function __wbg_get_wasmbn254fpgate_typ(a: number): number;
export function __wbg_set_wasmbn254fpgate_typ(a: number, b: number): void;
export function __wbg_get_wasmbn254fpgate_wires(a: number): number;
export function __wbg_set_wasmbn254fpgate_wires(a: number, b: number): void;
export function wasmbn254fpgate_new(a: number, b: number, c: number, d: number): number;
export function wasmbn254fpgate_get_coeffs_bigint(a: number, b: number): void;
export function caml_pasta_bn254_fp_plonk_gate_vector_create(): number;
export function caml_pasta_bn254_fp_plonk_gate_vector_add(a: number, b: number): void;
export function caml_pasta_bn254_fp_plonk_gate_vector_get(a: number, b: number): number;
export function caml_pasta_bn254_fp_plonk_gate_vector_len(a: number): number;
export function caml_pasta_bn254_fp_plonk_gate_vector_wrap(a: number, b: number, c: number): void;
export function caml_pasta_bn254_fp_plonk_gate_vector_digest(a: number, b: number, c: number): void;
export function caml_pasta_bn254_fp_plonk_circuit_serialize(a: number, b: number, c: number): void;
export function __wbg_wasmbn254fpplonkindex_free(a: number): void;
export function __wbg_wasmbn254fplookuptable_free(a: number): void;
export function wasmbn254fplookuptable_new(a: number, b: number): number;
export function caml_bn254_fp_plonk_index_create(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function caml_bn254_fp_plonk_index_max_degree(a: number): number;
export function caml_bn254_fp_plonk_index_public_inputs(a: number): number;
export function caml_bn254_fp_plonk_index_domain_d1_size(a: number): number;
export function caml_bn254_fp_plonk_index_domain_d4_size(a: number): number;
export function caml_bn254_fp_plonk_index_domain_d8_size(a: number): number;
export function caml_bn254_fp_plonk_index_read(a: number, b: number, c: number, d: number, e: number, f: number): void;
export function caml_bn254_fp_plonk_index_write(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_plonk_index_serialize(a: number, b: number): void;
export function __wbg_wasmbn254fplookupcommitments_free(a: number): void;
export function wasmbn254fplookupcommitments_new(a: number, b: number, c: number, d: number): number;
export function wasmbn254fplookupcommitments_sorted(a: number, b: number): void;
export function wasmbn254fplookupcommitments_aggreg(a: number): number;
export function wasmbn254fplookupcommitments_runtime(a: number): number;
export function wasmbn254fplookupcommitments_set_sorted(a: number, b: number, c: number): void;
export function wasmbn254fplookupcommitments_set_aggreg(a: number, b: number): void;
export function wasmbn254fplookupcommitments_set_runtime(a: number, b: number): void;
export function __wbg_wasmbn254fpprovercommitments_free(a: number): void;
export function wasmbn254fpprovercommitments_new(a: number, b: number, c: number, d: number, e: number): number;
export function wasmbn254fpprovercommitments_w_comm(a: number, b: number): void;
export function wasmbn254fpprovercommitments_z_comm(a: number): number;
export function wasmbn254fpprovercommitments_t_comm(a: number): number;
export function wasmbn254fpprovercommitments_lookup(a: number): number;
export function wasmbn254fpprovercommitments_set_w_comm(a: number, b: number, c: number): void;
export function wasmbn254fpprovercommitments_set_z_comm(a: number, b: number): void;
export function wasmbn254fpprovercommitments_set_t_comm(a: number, b: number): void;
export function wasmbn254fpprovercommitments_set_lookup(a: number, b: number): void;
export function __wbg_wasmbn254fpopeningproof_free(a: number): void;
export function __wbg_get_wasmbn254fpopeningproof_z1(a: number, b: number): void;
export function __wbg_set_wasmbn254fpopeningproof_z1(a: number, b: number, c: number): void;
export function __wbg_get_wasmbn254fpopeningproof_z2(a: number, b: number): void;
export function __wbg_set_wasmbn254fpopeningproof_z2(a: number, b: number, c: number): void;
export function wasmbn254fpopeningproof_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number): number;
export function wasmbn254fpopeningproof_lr_0(a: number, b: number): void;
export function wasmbn254fpopeningproof_lr_1(a: number, b: number): void;
export function wasmbn254fpopeningproof_delta(a: number): number;
export function wasmbn254fpopeningproof_sg(a: number): number;
export function wasmbn254fpopeningproof_set_lr_0(a: number, b: number, c: number): void;
export function wasmbn254fpopeningproof_set_lr_1(a: number, b: number, c: number): void;
export function wasmbn254fpopeningproof_set_delta(a: number, b: number): void;
export function wasmbn254fpopeningproof_set_sg(a: number, b: number): void;
export function __wbg_wasmbn254fpproverproof_free(a: number): void;
export function __wbg_get_wasmbn254fpproverproof_ft_eval1(a: number, b: number): void;
export function __wbg_set_wasmbn254fpproverproof_ft_eval1(a: number, b: number, c: number): void;
export function wasmbn254fpproverproof_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number): number;
export function wasmbn254fpproverproof_commitments(a: number): number;
export function wasmbn254fpproverproof_proof(a: number): number;
export function wasmbn254fpproverproof_evals(a: number): number;
export function wasmbn254fpproverproof_public_(a: number, b: number): void;
export function wasmbn254fpproverproof_prev_challenges_scalars(a: number): number;
export function wasmbn254fpproverproof_prev_challenges_comms(a: number, b: number): void;
export function wasmbn254fpproverproof_set_commitments(a: number, b: number): void;
export function wasmbn254fpproverproof_set_proof(a: number, b: number): void;
export function wasmbn254fpproverproof_set_evals(a: number, b: number): void;
export function wasmbn254fpproverproof_set_public_(a: number, b: number, c: number): void;
export function wasmbn254fpproverproof_set_prev_challenges_scalars(a: number, b: number): void;
export function wasmbn254fpproverproof_set_prev_challenges_comms(a: number, b: number, c: number): void;
export function wasmbn254fpproverproof_serialize(a: number, b: number): void;
export function __wbg_wasmbn254fpruntimetable_free(a: number): void;
export function wasmbn254fpruntimetable_new(a: number, b: number, c: number): number;
export function caml_bn254_fp_plonk_proof_create(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): void;
export function caml_bn254_fp_plonk_proof_verify(a: number, b: number): number;
export function __wbg_wasmvecvecbn254fppolycomm_free(a: number): void;
export function wasmvecvecbn254fppolycomm_create(a: number): number;
export function wasmvecvecbn254fppolycomm_push(a: number, b: number, c: number): void;
export function caml_bn254_fp_plonk_proof_batch_verify(a: number, b: number, c: number, d: number): number;
export function caml_bn254_fp_plonk_proof_dummy(): number;
export function caml_bn254_fp_plonk_proof_deep_copy(a: number): number;
export function prover_to_json(a: number, b: number): void;
export function prover_to_json_bn254(a: number, b: number): void;
export function wasmfqgate_get_coeffs_bigint(a: number, b: number): void;
export function wasmfpgate_get_coeffs_bigint(a: number, b: number): void;
...
export function __wbg_wasmbn254fpruntimetablecfg_free(a: number): void;
...
export function wasmbn254fpruntimetablecfg_new(a: number, b: number, c: number): number;
...
export function caml_bn254_fq_size(a: number): void;
export function caml_bn254_fq_add(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fq_sub(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fq_negate(a: number, b: number, c: number): void;
export function caml_bn254_fq_mul(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fq_div(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fq_inv(a: number, b: number, c: number): void;
export function caml_bn254_fq_square(a: number, b: number, c: number): void;
export function caml_bn254_fq_is_square(a: number, b: number): number;
export function caml_bn254_fq_sqrt(a: number, b: number, c: number): void;
export function caml_bn254_fq_of_int(a: number, b: number): void;
export function caml_bn254_fq_to_string(a: number, b: number, c: number): void;
export function caml_bn254_fq_of_string(a: number, b: number, c: number): void;
export function caml_bn254_fq_print(a: number, b: number): void;
export function caml_bn254_fq_compare(a: number, b: number, c: number, d: number): number;
export function caml_bn254_fq_equal(a: number, b: number, c: number, d: number): number;
export function caml_bn254_fq_random(a: number): void;
export function caml_bn254_fq_rng(a: number, b: number): void;
export function caml_bn254_fq_to_bigint(a: number, b: number, c: number): void;
export function caml_bn254_fq_of_bigint(a: number, b: number, c: number): void;
export function caml_bn254_fq_two_adic_root_of_unity(a: number): void;
export function caml_bn254_fq_domain_generator(a: number, b: number): void;
export function caml_bn254_fq_to_bytes(a: number, b: number, c: number): void;
export function caml_bn254_fq_of_bytes(a: number, b: number, c: number): void;
export function caml_bn254_fq_deep_copy(a: number, b: number, c: number): void;
export function __wbg_wasmpallasgprojective_free(a: number): void;
export function caml_pallas_one(): number;
export function caml_pallas_add(a: number, b: number): number;
export function caml_pallas_sub(a: number, b: number): number;
...
export function caml_pallas_affine_deep_copy(a: number): number;
export function __wbg_wasmvestagprojective_free(a: number): void;
export function __wbg_wasmvecvecbn254fp_free(a: number): void;
export function wasmvecvecbn254fp_create(a: number): number;
export function wasmvecvecbn254fp_push(a: number, b: number, c: number): void;
export function wasmvecvecbn254fp_get(a: number, b: number, c: number): void;
export function wasmvecvecbn254fp_set(a: number, b: number, c: number, d: number): void;
export function caml_pasta_fp_poseidon_block_cipher(a: number, b: number, c: number): void;
export function caml_pasta_fq_poseidon_block_cipher(a: number, b: number, c: number): void;
>>>>>>> origin/wasm_kzg_prover
...
export function caml_bn254_fp_size(a: number): void;
export function caml_bn254_fp_add(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_sub(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_negate(a: number, b: number, c: number): void;
export function caml_bn254_fp_mul(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_div(a: number, b: number, c: number, d: number, e: number): void;
export function caml_bn254_fp_inv(a: number, b: number, c: number): void;
export function caml_bn254_fp_square(a: number, b: number, c: number): void;
export function caml_bn254_fp_is_square(a: number, b: number): number;
export function caml_bn254_fp_sqrt(a: number, b: number, c: number): void;
export function caml_bn254_fp_of_int(a: number, b: number): void;
export function caml_bn254_fp_to_string(a: number, b: number, c: number): void;
export function caml_bn254_fp_of_string(a: number, b: number, c: number): void;
export function caml_bn254_fp_print(a: number, b: number): void;
export function caml_bn254_fp_compare(a: number, b: number, c: number, d: number): number;
export function caml_bn254_fp_equal(a: number, b: number, c: number, d: number): number;
export function caml_bn254_fp_random(a: number): void;
export function caml_bn254_fp_rng(a: number, b: number): void;
export function caml_bn254_fp_to_bigint(a: number, b: number, c: number): void;
export function caml_bn254_fp_of_bigint(a: number, b: number, c: number): void;
export function caml_bn254_fp_two_adic_root_of_unity(a: number): void;
export function caml_bn254_fp_domain_generator(a: number, b: number): void;
export function caml_bn254_fp_to_bytes(a: number, b: number, c: number): void;
export function caml_bn254_fp_of_bytes(a: number, b: number, c: number): void;
export function caml_bn254_fp_deep_copy(a: number, b: number, c: number): void;
export function caml_pasta_fq_size_in_bits(): number;
export function caml_pasta_fq_size(a: number): void;
export function caml_pasta_fq_add(a: number, b: number, c: number, d: number, e: number): void;
export function caml_pasta_fq_sub(a: number, b: number, c: number, d: number, e: number): void;

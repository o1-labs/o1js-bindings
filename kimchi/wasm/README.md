...
- [/src/lib/o1js/src/bindings/js/node_js/build.sh](/src/lib/o1js/src/bindings/js/node_js/build.sh) (also called from the `dune` file in the same folder)
- [/src/lib/o1js/src/bindings/js/web/build.sh](/src/lib/o1js/src/bindings/js/web/build.sh) (also called from the `dune` file in the same folder)

    ...
    (
     ...
     $field_name: ident
        ...
        paste! {
            ...
            #[wasm_bindgen]
            pub struct [<WasmPasta $field_name:camel RuntimeTable>] {
                id: i32,
                data: WasmFlatVector<$WasmF>
            }
            type WasmRuntimeTable = [<WasmPasta $field_name:camel RuntimeTable>];

            #[wasm_bindgen]
            impl [<WasmPasta $field_name:camel RuntimeTable>] {
                #[wasm_bindgen(constructor)]

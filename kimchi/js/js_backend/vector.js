...
var caml_bn254_fp_vector_create = function () {
  return [];
};
// Provides: caml_bn254_fp_vector_length
var caml_bn254_fp_vector_length = function (v) {
  return v.length;
};
// Provides: caml_bn254_fp_vector_emplace_back
var caml_bn254_fp_vector_emplace_back = function (v, x) {
  v.push(x);
};
// Provides: caml_bn254_fp_vector_get
var caml_bn254_fp_vector_get = function (v, i) {
  return v[i];
};
